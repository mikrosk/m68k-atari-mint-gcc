...
(define_expand "sincos<mode>3"
  [(parallel
    [(set (match_operand:FP 0 "nonimmediate_operand" "")
        (unspec:FP [(match_operand:FP 2 "general_operand" "")] UNSPEC_SINCOS)
     )
     (set (match_operand:FP 1 "nonimmediate_operand" "f<FP:dreg>m")
          (unspec:FP [(match_dup 2)] UNSPEC_SINCOS)
     )])]
  "TARGET_68881 && flag_unsafe_math_optimizations"
  "")
...
(define_insn "sincos<mode>2_68881"
  [(set (match_operand:FP 0 "nonimmediate_operand" "=f")
        (unspec:FP [(match_operand:FP 2 "register_operand" "")] UNSPEC_SINCOS)
   )
