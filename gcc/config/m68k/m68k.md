...
;; workaround:
;; 4 dummy insns used before reload:
;; 2 to load each register, 2 to store each register
;; reload will add necessary reloads
(define_insn "swap_dummy1"
  [(set (pc) (compare (match_operand 0 "register_operand" "r")
		               (match_operand 1 "register_operand" "r")))]
"")
(define_insn "swap_dummy2"
  [(set (match_operand 0 "register_operand" "=r") (pc))
   (set (match_operand 1 "register_operand" "=r") (pc))]
"")
...
(define_peephole2
  ...
  "1 && !reload_completed && peep2_reg_dead_p (3, operands[0])"
   [(set (pc) (compare (match_dup 1) (match_dup 2)))
	(parallel [(set (match_dup 1) (pc))
	           (set (match_dup 2) (pc))])]
  "")

;; and a final peephole to resolve the dummy insns.
(define_peephole2
   [(set (pc) (compare (match_operand 0 "register_operand" "") (match_operand 1 "register_operand" "")))
	(parallel [(set (match_dup 0) (pc))
			   (set (match_dup 1) (pc))])]
  "reload_completed"
...
;; and a peephole to remove the register load if two mems are used
;; 	move.l (52,sp),a6
;; move.l (48,sp),a5
;; exg a5,a6
;; move.l a5,(48,sp)
