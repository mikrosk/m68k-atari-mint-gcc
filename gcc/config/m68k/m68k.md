...
(define_peephole2
  ...
  "current_pass->static_pass_number >= 2 && !INTVAL (operands[1]) && INTVAL (operands[2]) + 4 == INTVAL (operands[3]) && (operands[4] = SET_DEST(PATTERN(insn))) && !operands[4]->volatil"
...
(define_peephole2
  ...
  "current_pass->static_pass_number >= 2 && !INTVAL (operands[1]) && (operands[3] = SET_DEST(PATTERN(insn))) && !operands[3]->volatil"
