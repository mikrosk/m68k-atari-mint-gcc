...
;; early split
(define_peephole2
  [(set (match_operand 0 "memory_operand") (match_operand 1 "const_int_operand"))]
"!reload_completed && INTVAL(operands[1]) >= -128 && INTVAL(operands[1]) < 127 && GET_MODE(operands[0]) != QImode"
  [(set (match_dup 2) (match_dup 1))
   (set (match_dup 0) (match_dup 2))]
 {
