...
(define_insn ""
  ...
  "!TARGET_COLDFIRE && !TUNE_68040_60 && !TUNE_68080"
{
...
(define_peephole2
  ...
  "!CONST_INT_P(operands[1]) && !ADDRESS_REG_P(operands[1]) && !reg_overlap_mentioned_p(operands[0], operands[1])"
  [(set (match_dup 0) (match_dup 2))
...
(define_peephole2
  ...
  "current_pass->static_pass_number == 1 && !reg_overlap_mentioned_p(operands[1], operands[0])"
  [(set (match_dup 4) (match_dup 3))
   (set (cc0) (match_dup 0))
   (set (match_dup 1) (match_dup 2))
...
;; combine temp reg away with auto_inc memory ref: PLUS
(define_peephole2
  [(set (match_operand:VOID 0 "register_operand" "")
	    (plus:VOID (match_dup 0) (mem:VOID (match_operand:SI 1 "register_operand" ""))))
   (set (match_operand:VOID 2 "memory_operand")
	    (match_dup 0))]
  "DATA_REG_P(operands[0]) && ADDRESS_REG_P(operands[1])
   && GET_CODE(XEXP(operands[2],0)) == POST_INC && rtx_equal_p(operands[1], XEXP(XEXP(operands[2],0),0))
   && peep2_reg_dead_p (2, operands[0])"
  [(set (match_dup 2) (match_dup 4))]
  "operands[4] = gen_rtx_PLUS(GET_MODE(operands[0]), gen_rtx_raw_MEM(GET_MODE(operands[0]), operands[1]), operands[0]);")

;; 2nd variant: PLUS
(define_peephole2
  [(set (match_operand:VOID 0 "register_operand" "")
		(mem:VOID (match_operand:SI 1 "register_operand" "")))
   (set (match_dup 0) 
		(plus:VOID (match_dup 0) (match_operand:VOID 3 "register_operand" "")))
   (set (match_operand:VOID 2 "memory_operand")
		(match_dup 0))]
  "DATA_REG_P(operands[0]) && ADDRESS_REG_P(operands[1])
   && GET_CODE(XEXP(operands[2],0)) == POST_INC && rtx_equal_p(operands[1], XEXP(XEXP(operands[2],0),0))
...
;; combine temp reg away with auto_inc memory ref: MINUS
(define_peephole2
  [(set (match_operand:VOID 0 "register_operand" "")
	  (mem:VOID (match_operand:SI 1 "register_operand" "")))
   (set (match_operand:VOID 2 "memory_operand")
	  (minus:VOID (match_dup 0) (match_operand:VOID 3 "general_src_operand" "")))]
  "DATA_REG_P(operands[0]) && ADDRESS_REG_P(operands[1])
   && GET_CODE(XEXP(operands[2],0)) == POST_INC && rtx_equal_p(operands[1], XEXP(XEXP(operands[2],0),0))
   && peep2_reg_dead_p (2, operands[0])"
  [(set (match_dup 2) (match_dup 4))]
  "operands[4] = gen_rtx_MINUS(GET_MODE(operands[0]), gen_rtx_raw_MEM(GET_MODE(operands[0]), operands[1]), operands[3]);")
...
(define_peephole2
  [(set (match_operand:VOID 0 "register_operand" "")
		(mem:VOID (match_operand:SI 1 "register_operand" "")))
   (set (match_dup 0) 
		(minus:VOID (match_dup 0) (match_operand:VOID 3 "register_operand" "")))
   (set (match_operand:VOID 2 "memory_operand")
		(match_dup 0))]
  "DATA_REG_P(operands[0]) && ADDRESS_REG_P(operands[1])
   && GET_CODE(XEXP(operands[2],0)) == POST_INC && rtx_equal_p(operands[1], XEXP(XEXP(operands[2],0),0))
...
(define_peephole2
  [(set (match_operand:VOID 0 "register_operand" "")
   ...
   (set (match_operand 2 "memory_operand")
	  (and:VOID (match_dup 0) (match_operand:VOID 3 "general_src_operand" "")))]
  "DATA_REG_P(operands[0]) && ADDRESS_REG_P(operands[1])
   && GET_CODE(XEXP(operands[2],0)) == POST_INC && rtx_equal_p(operands[1], XEXP(XEXP(operands[2],0),0))
   && peep2_reg_dead_p (2, operands[0])"
  [(set (match_dup 2) (match_dup 4))]
...
(define_peephole2
  [(set (match_operand:VOID 0 "register_operand" "")
		(mem:VOID (match_operand:SI 1 "register_operand" "")))
   (set (match_dup 0) 
		(and:VOID (match_dup 0) (match_operand:VOID 3 "register_operand" "")))
   (set (match_operand:VOID 2 "memory_operand")
		(match_dup 0))]
  "DATA_REG_P(operands[0]) && ADDRESS_REG_P(operands[1])
   && GET_CODE(XEXP(operands[2],0)) == POST_INC && rtx_equal_p(operands[1], XEXP(XEXP(operands[2],0),0))
...
(define_peephole2
  [(set (match_operand:VOID 0 "register_operand" "")
	  (mem:VOID (match_operand:SI 1 "register_operand" "")))
   (set (match_operand:VOID 2 "memory_operand")
	  (ior:VOID (match_dup 0) (match_operand:VOID 3 "general_src_operand" "")))]
  "DATA_REG_P(operands[0]) && ADDRESS_REG_P(operands[1])
   && GET_CODE(XEXP(operands[2],0)) == POST_INC && rtx_equal_p(operands[1], XEXP(XEXP(operands[2],0),0))
   && peep2_reg_dead_p (2, operands[0])"
  [(set (match_dup 2) (match_dup 4))]
...
(define_peephole2
  [(set (match_operand:VOID 0 "register_operand" "")
		(mem:VOID (match_operand:SI 1 "register_operand" "")))
   (set (match_dup 0) 
		(ior:VOID (match_dup 0) (match_operand:VOID 3 "register_operand" "")))
   (set (match_operand:VOID 2 "memory_operand")
		(match_dup 0))]
  "DATA_REG_P(operands[0]) && ADDRESS_REG_P(operands[1])
   && GET_CODE(XEXP(operands[2],0)) == POST_INC && rtx_equal_p(operands[1], XEXP(XEXP(operands[2],0),0))
...
(define_peephole2
  [(set (match_operand:VOID 0 "register_operand" "")
	  (mem:VOID (match_operand:SI 1 "register_operand" "")))
   (set (match_operand:VOID 2 "memory_operand")
	  (xor (match_dup 0) (match_operand:VOID 3 "general_src_operand" "")))]
  "DATA_REG_P(operands[0]) && ADDRESS_REG_P(operands[1])
   && GET_CODE(XEXP(operands[2],0)) == POST_INC && rtx_equal_p(operands[1], XEXP(XEXP(operands[2],0),0))
   && peep2_reg_dead_p (2, operands[0])"
  [(set (match_dup 2) (match_dup 4))]
...
(define_peephole2
  [(set (match_operand:VOID 0 "register_operand" "")
		(mem:VOID (match_operand:SI 1 "register_operand" "")))
   (set (match_dup 0) 
		(xor:VOID (match_dup 0) (match_operand:VOID 3 "register_operand" "")))
   (set (match_operand:VOID 2 "memory_operand")
		(match_dup 0))]
  "DATA_REG_P(operands[0]) && ADDRESS_REG_P(operands[1])
   && GET_CODE(XEXP(operands[2],0)) == POST_INC && rtx_equal_p(operands[1], XEXP(XEXP(operands[2],0),0))
