...
(define_peephole2
  ...
  "TARGET_68080 && current_pass->static_pass_number >= 2 && !INTVAL (operands[1]) && INTVAL (operands[2]) + 4 == INTVAL (operands[3]) && (operands[4] = SET_DEST(PATTERN(insn))) && !operands[4]->volatil"
...
(define_peephole2
  [(set (match_operand:SI 0 "register_operand" "")
   ...
   (set (mem (match_dup 0))
   		(match_operand:SI 3 "general_src_operand" ""))
   ]
  "!reg_overlap_mentioned_p(operands[0], operands[3]) && (operands[4] = SET_DEST(PATTERN(NEXT_INSN(insn))))"
  [(set (match_dup 4) (match_dup 3))
   (set (match_dup 0) (plus:SI (match_dup 1) (match_dup 2)))]
{
  operands[4] = gen_rtx_MEM (GET_MODE(operands[4]), gen_rtx_PLUS(SImode, operands[1], operands[2])); 
})
...
(define_peephole2
  [(set (match_operand:SI 0 "register_operand" "")
   ...
   (set (match_operand 3 "memory_operand" "") 
   		(match_operand:SI 4 "general_src_operand" ""))
   ]
...
(define_peephole2
  ...
  "!reg_overlap_mentioned_p(operands[0], operands[4]) && (operands[5] = SET_DEST(PATTERN(NEXT_INSN(insn))))"
  [(set (match_dup 5) (match_dup 4))
   (set (match_dup 0) (plus:SI (match_dup 1) (match_dup 2)))]
{
  operands[5] = gen_rtx_MEM (GET_MODE(operands[5]), gen_rtx_PLUS(SImode, operands[1], 
                             GEN_INT (INTVAL(operands[2]) + INTVAL(operands[3]))));
})
...
(define_peephole2
  ...
  "ADDRESS_REG_P (operands[1]) && IN_RANGE (INTVAL (operands[2]) + INTVAL (operands[3]), -32768, 32767) && peep2_reg_dead_p (2, operands[0])"
