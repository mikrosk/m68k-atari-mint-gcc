...
(define_insn ""
  [(set
    (cc0)
    (compare (zero_extract:SI (match_operand:QI 0 "memory_operand" "oV")
			       (const_int 1)
			       (minus:SI (const_int 7)
				         (and:SI
...
(define_insn "*adddi_dilshr32"
  [(set (match_operand:DI 0 "nonimmediate_operand" "=d,oV")
...
(define_insn "*adddi_dilshr32_cf"
  [(set (match_operand:DI 0 "register_operand" "=d")
	(plus:DI (lshiftrt:DI (match_operand:DI 1 "nonimmediate_operand" "roV")
			      (const_int 32))
...
(define_insn "*extv_bfexts_mem"
  [(set (match_operand:SI 0 "register_operand" "=d")
	(sign_extract:SI (match_operand:SI 1 "memory_operand" "oV")
...
(define_insn "*extv_bfexts_mem1"
  [(set (match_operand:SI 0 "register_operand" "=d")
	(sign_extract:SI (match_operand:HI 1 "memory_operand" "oV")
			 (match_operand:SI 2 "nonmemory_operand" "dn")
			 (match_operand:SI 3 "nonmemory_operand" "dn")))]
  "TARGET_68020 && TARGET_BITFIELD"
  "bfexts %1{%b3:%b2},%0")
...
(define_insn "*extv_bfexts_mem2"
  [(set (match_operand:SI 0 "register_operand" "=d")
	(sign_extract:SI (match_operand:QI 1 "memory_operand" "oV")
			 (match_operand:SI 2 "nonmemory_operand" "dn")
			 (match_operand:SI 3 "nonmemory_operand" "dn")))]
  "TARGET_68020 && TARGET_BITFIELD"
  "bfexts %1{%b3:%b2},%0")
...
(define_insn "*extzv_bfextu_mem"
  [(set (match_operand:SI 0 "register_operand" "=d")
	(zero_extract:SI (match_operand:SI 1 "memory_operand" "oV")
			 (match_operand:SI 2 "nonmemory_operand" "dn")
			 (match_operand:SI 3 "nonmemory_operand" "dn")))]
  "TARGET_68020 && TARGET_BITFIELD"
{
...
(define_insn "*extzv_bfextu_mem1"
  [(set (match_operand:SI 0 "register_operand" "=d")
	(zero_extract:SI (match_operand:HI 1 "memory_operand" "oV")
			 (match_operand:SI 2 "nonmemory_operand" "dn")
			 (match_operand:SI 3 "nonmemory_operand" "dn")))]
  "TARGET_68020 && TARGET_BITFIELD"
{
...
(define_insn "*extzv_bfextu_mem2"
  [(set (match_operand:SI 0 "register_operand" "=d")
	(zero_extract:SI (match_operand:QI 1 "memory_operand" "oV")
			 (match_operand:SI 2 "nonmemory_operand" "dn")
			 (match_operand:SI 3 "nonmemory_operand" "dn")))]
  "TARGET_68020 && TARGET_BITFIELD"
{
...
(define_insn "*insv_bfchg_mem"
  [(set (zero_extract:SI (match_operand:SI 0 "memory_operand" "+oV")
...
(define_insn "*insv_bfchg_mem1"
  [(set (zero_extract:SI (match_operand:HI 0 "memory_operand" "+oV")
			 (match_operand:SI 1 "nonmemory_operand" "dn")
			 (match_operand:SI 2 "nonmemory_operand" "dn"))
        (xor:SI (zero_extract:SI (match_dup 0) (match_dup 1) (match_dup 2))
		(match_operand 3 "const_int_operand" "n")))]
...
(define_insn "*insv_bfchg_mem2"
  [(set (zero_extract:SI (match_operand:QI 0 "memory_operand" "+oV")
			 (match_operand:SI 1 "nonmemory_operand" "dn")
			 (match_operand:SI 2 "nonmemory_operand" "dn"))
        (xor:SI (zero_extract:SI (match_dup 0) (match_dup 1) (match_dup 2))
		(match_operand 3 "const_int_operand" "n")))]
...
(define_insn "*tst_bftst_mem"
  [(set (cc0)
	(compare (zero_extract:SI (match_operand:SI 0 "memory_operand" "oV")
				  (match_operand:SI 1 "const_int_operand" "n")
				  (match_operand:SI 2 "general_operand" "dn"))
	         (const_int 0)))]
  "TARGET_68020 && TARGET_BITFIELD"
...
(define_insn "*tst_bftst_mem1"
  [(set (cc0)
	(compare (zero_extract:SI (match_operand:HI 0 "memory_operand" "oV")
				  (match_operand:SI 1 "const_int_operand" "n")
				  (match_operand:SI 2 "general_operand" "dn"))
	         (const_int 0)))]
  "TARGET_68020 && TARGET_BITFIELD"
