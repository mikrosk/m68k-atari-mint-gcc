...
(define_insn "*addsi3_internal"
  [(set (match_operand:SI 0 "nonimmediate_operand" "=m,a,?a,?a,d")
        (plus:SI (match_operand:SI 1 "general_operand" "%0,0,a,rJK,0")
                 (match_operand:SI 2 "general_src_operand" "dIKLT,mSrIKLs,rJK,a,mSrIKLT")))]
