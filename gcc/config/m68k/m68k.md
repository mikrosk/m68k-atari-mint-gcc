...
(define_insn "*mulsi3_68060"
  [(set (match_operand:SI 0 "nonimmediate_operand" "=d")
	(mult:SI (match_operand:SI 1 "general_operand" "dmSTK")
...
(define_expand "mulsi3"
  [(set (match_operand:SI 0 "nonimmediate_operand" "")
	(mult:SI (match_operand:SI 1 "general_operand" "")
		 (match_operand:SI 2 "general_operand" "")))]
  "TUNE_68020_80 || TARGET_COLDFIRE"
  {
    if (TARGET_68060)
      {
        emit_insn(gen_mulsi3_68060(operands[0], operands[1], operands[2]));
        DONE;
      }    
  })
    ...
    [(set (subreg:SI (match_operand:DI 0 "register_operand" "") 4)
     ...
     (set (subreg:SI (match_dup 0) 0)
	  (truncate:SI (lshiftrt:DI (mult:DI (zero_extend:DI (match_dup 1))
				    ...
				    (const_int 32))))])]
  "TUNE_68020_80 && !TUNE_68060 && !TARGET_COLDFIRE"
  "")
    ...
    [(set (subreg:SI (match_operand:DI 0 "register_operand" "") 4)
     ...
     (set (subreg:SI (match_dup 0) 0)
	  (truncate:SI (lshiftrt:DI (mult:DI (sign_extend:DI (match_dup 1))
				    ...
				    (const_int 32))))])]
  "TUNE_68020_80 && !TARGET_68060 && !TARGET_COLDFIRE"
  "")
...
(define_peephole2
  ...
  "(DATA_REG_P(operands[1]) || MEM_P(operands[1])) && !reg_overlap_mentioned_p(operands[0], operands[1])
   && (INTVAL(operands[2]) > 8 || INTVAL(operands[2]) < -8 || ADDRESS_REG_P(operands[0]))
  "
  [(set (match_dup 0) (match_dup 2))
...
(define_peephole2
  ...
  && ((GET_CODE (XEXP (operands[1], 0)) == PLUS && REG_P(XEXP (XEXP (operands[1], 0), 0)) && CONST_INT_P(XEXP (XEXP (operands[1], 0), 0))) 
